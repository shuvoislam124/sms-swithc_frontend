...
import { AuthGuard } from './account/login/auth-guard';
import { AdminAuthGuard } from './account/login/admin-auth-guard';
...
const routes: Routes = [
    ...
    {path:'user', data:{breadcumb:'User'}, loadChildren:()=>import('../app/account/account.module').then(m=>m.AccountModule)},
